...
import type { AnthropicConfig, OpenAIConfig, GoogleConfig, OpenRouterConfig } from "@mariozechner/lemmy";
...
export type ProviderConfig = AnthropicConfig | OpenAIConfig | GoogleConfig | OpenRouterConfig;
